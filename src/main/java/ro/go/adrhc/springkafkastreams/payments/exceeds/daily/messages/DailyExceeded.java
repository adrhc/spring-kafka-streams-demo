 ...
 */
package ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages;
...
public class DailyExceeded extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
	...
	private ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent dailyTotalSpent;
	 ...
	 */
	public DailyExceeded(java.lang.Integer dailyMaxAmount, ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent dailyTotalSpent) {
	 ...
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder newBuilder() {
		return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder();
	}
	 ...
	 * @return A new DailyExceeded RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder newBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder(other);
		}
	}
	 ...
	 * @return A new DailyExceeded RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder newBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder(other);
	...
	public void put(int field$, java.lang.Object value$) {
		switch (field$) {
			case 0:
				...
				break;
			case 1:
				dailyTotalSpent = (ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent) value$;
				break;
			default:
				throw new org.apache.avro.AvroRuntimeException("Bad index");
		}
	 ...
	 */
	public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent getDailyTotalSpent() {
		return dailyTotalSpent;
	}
	 ...
	 * @param value the value to set.
	 */
	public void setDailyTotalSpent(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent value) {
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DailyExceeded>
		...
		private int dailyMaxAmount;
		private ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent dailyTotalSpent;
		private ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder dailyTotalSpentBuilder;
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder other) {
			super(other);
			...
			if (other.hasDailyTotalSpentBuilder()) {
				this.dailyTotalSpentBuilder = ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.newBuilder(other.getDailyTotalSpentBuilder());
			}
		}
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded other) {
			super(SCHEMA$);
			if (isValidValue(fields()[0], other.dailyMaxAmount)) {
				this.dailyMaxAmount = data().deepCopy(fields()[0].schema(), other.dailyMaxAmount);
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder setDailyMaxAmount(int value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder clearDailyMaxAmount() {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder setDailyTotalSpent(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder getDailyTotalSpentBuilder() {
			if (dailyTotalSpentBuilder == null) {
				if (hasDailyTotalSpent()) {
					setDailyTotalSpentBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.newBuilder(dailyTotalSpent));
				} else {
					setDailyTotalSpentBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.newBuilder());
				}
			}
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder setDailyTotalSpentBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyExceeded.Builder clearDailyTotalSpent() {
		...
		public DailyExceeded build() {
			try {
				...
				if (dailyTotalSpentBuilder != null) {
					...
					record.dailyTotalSpent = fieldSetFlags()[1] ? this.dailyTotalSpent : (ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent) defaultValue(fields()[1]);
				}
				return record;
			} catch (org.apache.avro.AvroMissingFieldException e) {
				throw e;
