...
public class PeriodExceeded extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
	...
	private ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent periodTotalSpent;
	 ...
	 */
	public PeriodExceeded(java.lang.Integer periodMaxAmount, ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent periodTotalSpent) {
	 ...
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder newBuilder() {
		return new ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder();
	}
	 ...
	 * @return A new PeriodExceeded RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder newBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder(other);
		}
	}
	 ...
	 * @return A new PeriodExceeded RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder newBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder(other);
	...
	public void put(int field$, java.lang.Object value$) {
		switch (field$) {
			case 0:
				...
				break;
			case 1:
				periodTotalSpent = (ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent) value$;
				break;
			default:
				throw new org.apache.avro.AvroRuntimeException("Bad index");
		}
	 ...
	 */
	public ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent getPeriodTotalSpent() {
		return periodTotalSpent;
	}
	 ...
	 * @param value the value to set.
	 */
	public void setPeriodTotalSpent(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent value) {
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PeriodExceeded>
		...
		private int periodMaxAmount;
		private ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent periodTotalSpent;
		private ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent.Builder periodTotalSpentBuilder;
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder other) {
			super(other);
			...
			if (other.hasPeriodTotalSpentBuilder()) {
				this.periodTotalSpentBuilder = ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent.newBuilder(other.getPeriodTotalSpentBuilder());
			}
		}
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded other) {
			super(SCHEMA$);
			if (isValidValue(fields()[0], other.periodMaxAmount)) {
				this.periodMaxAmount = data().deepCopy(fields()[0].schema(), other.periodMaxAmount);
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder setPeriodMaxAmount(int value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder clearPeriodMaxAmount() {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder setPeriodTotalSpent(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent.Builder getPeriodTotalSpentBuilder() {
			if (periodTotalSpentBuilder == null) {
				if (hasPeriodTotalSpent()) {
					setPeriodTotalSpentBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent.newBuilder(periodTotalSpent));
				} else {
					setPeriodTotalSpentBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent.newBuilder());
				}
			}
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder setPeriodTotalSpentBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent.Builder value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodExceeded.Builder clearPeriodTotalSpent() {
		...
		public PeriodExceeded build() {
			try {
				...
				if (periodTotalSpentBuilder != null) {
					...
					record.periodTotalSpent = fieldSetFlags()[1] ? this.periodTotalSpent : (ro.go.adrhc.springkafkastreams.payments.exceeds.period.messages.PeriodTotalSpent) defaultValue(fields()[1]);
				}
				return record;
			} catch (org.apache.avro.AvroMissingFieldException e) {
				throw e;
