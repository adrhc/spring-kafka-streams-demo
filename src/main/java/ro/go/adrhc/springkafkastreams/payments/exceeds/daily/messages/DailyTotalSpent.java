...
public class DailyTotalSpent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DailyTotalSpent\",\"namespace\":\"ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages\",\"fields\":[{\"name\":\"clientId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"time\",\"type\":{\"type\":\"int\",\"logicalType\":\"date\"}},{\"name\":\"amount\",\"type\":\"int\"}]}");
	private static final long serialVersionUID = -4935183316588766224L;
	 ...
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder newBuilder() {
		return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder();
	}
	 ...
	 * @return A new DailyTotalSpent RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder newBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder(other);
		}
	}
	 ...
	 * @return A new DailyTotalSpent RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder newBuilder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DailyTotalSpent>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent other) {
			super(SCHEMA$);
			if (isValidValue(fields()[0], other.clientId)) {
				this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder setClientId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder clearClientId() {
			clientId = null;
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder setTime(java.time.LocalDate value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder clearTime() {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder setAmount(int value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.payments.exceeds.daily.messages.DailyTotalSpent.Builder clearAmount() {
