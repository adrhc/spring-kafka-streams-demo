...
public class Transaction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transaction\",\"namespace\":\"ro.go.adrhc.springkafkastreams.messages\",\"fields\":[{\"name\":\"time\",\"type\":{\"type\":\"int\",\"logicalType\":\"date\"}},{\"name\":\"merchantId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"clientId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"amount\",\"type\":\"int\"}]}");
	private static final long serialVersionUID = 1675599187372358878L;
	 ...
	 */
	public static ro.go.adrhc.springkafkastreams.messages.Transaction.Builder newBuilder() {
		return new ro.go.adrhc.springkafkastreams.messages.Transaction.Builder();
	}
	 ...
	 * @return A new Transaction RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.messages.Transaction.Builder newBuilder(ro.go.adrhc.springkafkastreams.messages.Transaction.Builder other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.messages.Transaction.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.messages.Transaction.Builder(other);
		}
	}
	 ...
	 * @return A new Transaction RecordBuilder
	 */
	public static ro.go.adrhc.springkafkastreams.messages.Transaction.Builder newBuilder(ro.go.adrhc.springkafkastreams.messages.Transaction other) {
		if (other == null) {
			return new ro.go.adrhc.springkafkastreams.messages.Transaction.Builder();
		} else {
			return new ro.go.adrhc.springkafkastreams.messages.Transaction.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transaction>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.messages.Transaction.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(ro.go.adrhc.springkafkastreams.messages.Transaction other) {
			super(SCHEMA$);
			if (isValidValue(fields()[0], other.time)) {
				this.time = data().deepCopy(fields()[0].schema(), other.time);
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder setTime(java.time.LocalDate value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder clearTime() {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder setMerchantId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder clearMerchantId() {
			merchantId = null;
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder setClientId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder clearClientId() {
			clientId = null;
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder setAmount(int value) {
		 ...
		 * @return This builder.
		 */
		public ro.go.adrhc.springkafkastreams.messages.Transaction.Builder clearAmount() {
