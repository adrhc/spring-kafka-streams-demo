...
public class Command extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static ro.go.adrhc.springkafkastreams.messages.Command.Builder newBuilder() {
    return new ro.go.adrhc.springkafkastreams.messages.Command.Builder();
  }
   ...
   * @return A new Command RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.messages.Command.Builder newBuilder(ro.go.adrhc.springkafkastreams.messages.Command.Builder other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.messages.Command.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.messages.Command.Builder(other);
    }
  }
   ...
   * @return A new Command RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.messages.Command.Builder newBuilder(ro.go.adrhc.springkafkastreams.messages.Command other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.messages.Command.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.messages.Command.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Command>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.messages.Command.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.messages.Command other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.messages.Command.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.messages.Command.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.messages.Command.Builder setParameters(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.messages.Command.Builder clearParameters() {
      parameters = null;
