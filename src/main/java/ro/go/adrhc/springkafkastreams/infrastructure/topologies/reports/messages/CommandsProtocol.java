...
public interface CommandsProtocol {
	...
	public interface Callback extends CommandsProtocol {
		public static final org.apache.avro.Protocol PROTOCOL = ro.go.adrhc.springkafkastreams.infrastructure.topologies.reports.messages.CommandsProtocol.PROTOCOL;
	}
}
