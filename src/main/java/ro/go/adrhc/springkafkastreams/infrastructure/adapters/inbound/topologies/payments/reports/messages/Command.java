 ...
 */
package ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages;
...
public class Command extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Command\",\"namespace\":\"ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"parameters\",\"type\":[\"null\",{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}]}");
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: parameters = (java.util.List<java.lang.String>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder newBuilder() {
    return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder();
  }
   ...
   * @return A new Command RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder newBuilder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder(other);
    }
  }
   ...
   * @return A new Command RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder newBuilder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Command>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder setParameters(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.reports.messages.Command.Builder clearParameters() {
      parameters = null;
    ...
    public Command build() {
      try {
        ...
        record.parameters = fieldSetFlags()[1] ? this.parameters : (java.util.List<java.lang.String>) defaultValue(fields()[1]);
        return record;
