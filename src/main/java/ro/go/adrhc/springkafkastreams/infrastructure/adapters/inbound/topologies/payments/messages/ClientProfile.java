...
public class ClientProfile extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3549926615043442191L;
   ...
   */
  public static ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder newBuilder() {
    return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder();
  }
   ...
   * @return A new ClientProfile RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder newBuilder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder(other);
    }
  }
   ...
   * @return A new ClientProfile RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder newBuilder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientProfile>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder setDailyMaxAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder clearDailyMaxAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder setPeriodMaxAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.infrastructure.adapters.inbound.topologies.payments.messages.ClientProfile.Builder clearPeriodMaxAmount() {
