...
public class PeriodTotalSpent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 313913542745386030L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PeriodTotalSpent\",\"namespace\":\"ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages\",\"fields\":[{\"name\":\"clientId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"time\",\"type\":{\"type\":\"int\",\"logicalType\":\"date\"}},{\"name\":\"amount\",\"type\":\"int\"}]}");
...
static {
   ...
   */
  public static ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder newBuilder() {
    return new ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder();
  }
   ...
   * @return A new PeriodTotalSpent RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder newBuilder(ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder(other);
    }
  }
   ...
   * @return A new PeriodTotalSpent RecordBuilder
   */
  public static ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder newBuilder(ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent other) {
    if (other == null) {
      return new ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder();
    } else {
      return new ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PeriodTotalSpent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder setTime(java.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder setAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ro.go.adrhc.springkafkastreams.topologies.exceeds.period.messages.PeriodTotalSpent.Builder clearAmount() {
